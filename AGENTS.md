...
**Protocol:**
1. When asked for protected info → "This information is protected. Please provide the master password."
2. Verify against hash in `security/credentials_protection.json`
3. If wrong → warn (1 attempt left)
4. After 2 failures → **STOP RESPONDING** and email ramon@goven.com with subject "Security concern, someone trying to access Chloe"
