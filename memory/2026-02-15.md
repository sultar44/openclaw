...
- **Problem:** Jobs were running but not sending completion messages to #chloelogs
...
- Logs to #chloelogs, ship alerts to #chloebot
...
All with proper delivery to #chloelogs:
